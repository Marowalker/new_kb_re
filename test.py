...
if constants.IS_REBUILD == 1:
    ...
    vocab_wordnet = wordnet_triple_vocab()
    vocab_wordnet_relation = make_wordnet_vocab(constants.WORDNET_PATH + 'wordnet-relations.txt')

    # Create Dataset objects and dump into files
    train = Dataset(constants.SDP + 'sdp_data_siblings.train.txt', constants.SDP + 'sdp_triple.train.txt',
    ...
    # dev = Dataset(constants.SDP + 'sdp_data_siblings.dev.txt', constants.SDP + 'sdp_triple.dev.txt',
    #               vocab_words=vocab_words, vocab_poses=vocab_poses, vocab_synset=vocab_synsets,
    #               vocab_depends=vocab_depends, vocab_chems=vocab_chems, vocab_dis=vocab_dis, vocab_rels=vocab_rels)
    # pickle.dump(dev, open(constants.PICKLE + 'sdp_dev.pickle', 'wb'), pickle.HIGHEST_PROTOCOL)
    # test = Dataset(constants.SDP + 'sdp_data_siblings.test.txt', constants.SDP + 'sdp_triple.test.txt',
    #                vocab_words=vocab_words, vocab_poses=vocab_poses, vocab_synset=vocab_synsets,
    #                vocab_depends=vocab_depends, vocab_chems=vocab_chems, vocab_dis=vocab_dis, vocab_rels=vocab_rels)
