...
class TransEModel:
    ...
    def _add_embeddings(self):
        # generate embeddings
        self.chemical_embeddings = tf.keras.layers.Embedding(self.chem_size + 1, constants.INPUT_W2V_DIM)
        # self.chemical_embeddings = tf.nn.l2_normalize(self.chemical_embeddings, axis=1)

        self.disease_embeddings = tf.keras.layers.Embedding(self.dis_size + 1, constants.INPUT_W2V_DIM)
        ...
        self.head__neglookup = tf.nn.l2_normalize(self.head_neg_lookup, axis=1)
